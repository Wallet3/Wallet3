 ...
 *
 * @see https://github.com/ushelp/EasyQRCode-React-Native
 ...
 */
var Drawing = function (canvas, htOption) {
...
Drawing.prototype.draw = function (oQRCode) {
  ...
  if (_htOption.backgroundImage) {
    // backgroundImage
    var bgImg = new CanvasImage(t._canvas);
    ...
    // if(!(_htOption.backgroundImage.startsWith("http://") || _htOption.backgroundImage.startsWith("https://") || _htOption.backgroundImage.startsWith("ftp://"))){
    //     imageSrc = Image.resolveAssetSource(require(_htOption.backgroundImage)).uri;
    // }
...
function QRCode(canvas, vOption) {
  this.canvas = canvas;
  this._htOption = {
    width: 256,
    height: 256,
  ...
  if (this._htOption.dotScaleTiming < 0 || this._htOption.dotScaleTiming > 1) {
    console.warn(
      `${this._htOption.dotScaleTiming} , is invalidate, dotScaleTiming must greater than 0, less than or equal to 1, now reset to 1. `
    );
  ...
  if (this._htOption.dotScaleTiming_H) {
    if (this._htOption.dotScaleTiming_H < 0 || this._htOption.dotScaleTiming_H > 1) {
      console.warn(
        `${this._htOption.dotScaleTiming_H} , is invalidate, dotScaleTiming_H must greater than 0, less than or equal to 1, now reset to 1. `
      );
  ...
  if (this._htOption.dotScaleTiming_V) {
    if (this._htOption.dotScaleTiming_V < 0 || this._htOption.dotScaleTiming_V > 1) {
      console.warn(
        `${this._htOption.dotScaleTiming_V} , is invalidate, dotScaleTiming_V must greater than 0, less than or equal to 1, now reset to 1. `
      );
  ...
  if (this._htOption.dotScaleA < 0 || this._htOption.dotScaleA > 1) {
    console.warn(
      `${this._htOption.dotScaleA} , is invalidate, dotScaleA must greater than 0, less than or equal to 1, now reset to 1. `
    );
  ...
  if (this._htOption.dotScaleAO) {
    if (this._htOption.dotScaleAO < 0 || this._htOption.dotScaleAO > 1) {
      console.warn(
        `${this._htOption.dotScaleAO} , is invalidate, dotScaleAO must greater than 0, less than or equal to 1, now reset to 1. `
      );
  ...
  if (this._htOption.dotScaleAI) {
    if (this._htOption.dotScaleAI < 0 || this._htOption.dotScaleAI > 1) {
      console.warn(
        `${this._htOption.dotScaleAI} , is invalidate, dotScaleAI must greater than 0, less than or equal to 1, now reset to 1. `
      );

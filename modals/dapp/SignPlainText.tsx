...
export default observer(
  ({ msg, themeColor, onReject, onSign, account, bioType, onStandardModeChanged, metadata, standardMode }: Props) => {
    const { t } = i18n;
    ...
    return (
      <SafeViewContainer style={{}}>
        ...
        <RejectApproveButtons
          ...
          approveIcon={
            siwe ? () => <FontAwesome5 name="ethereum" size={18} color="#fff" style={{ marginEnd: 1 }} /> : authIcon
          }
          onApprove={() => {
            setBusy(true);
